    ...
    try {
      const response = await fetch("/api/consultation", {
        ...
        body: JSON.stringify({
          ...
          itService: consultationData.itService,
        }),
      });
      const result = await response.json();
      ...
      if (result.success) {
        toast({
          title: "Request Sent!",
          description: "Thank you! We'll be in touch for your free consultation.",
          type: "success",
        });
        setConsultationData({
          firstName: "",
        ...
        <div className="relative z-20">
          ...
          >
            <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <a
                href="tel:0800724526"
                className="bg-white text-[#53B289] hover:bg-gray-100 font-semibold px-6 py-2 rounded-md transition-colors flex items-center gap-2"
              >
                Call 0800 724 526
              </a>
            </div>
            ...
            <nav className="flex items-center justify-between px-6 lg:px-12 py-6">
              ...
              >
                <div className="bg-white rounded-lg p-2 shadow-sm">
                  <img src="/images/logo.png" alt="COMSYS Security Logo" className="h-12 w-auto" />
                </div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-white/80 max-w-lg leading-relaxed">
                    Professional security solutions for homes and businesses in New Zealand. From high-definition cameras
                    to smart analytics, we protect what matters most.
                  </p>
                </div>
              ...
              >
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-[#C0E3D4] max-w-md ml-auto">
                  ...
                  <form onSubmit={handleConsultationSubmit} className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-[#3A4E62] mb-2">First Name *</label>
                      <Input
                        name="firstName"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#3A4E62] mb-2">Last Name *</label>
                      <Input
                        name="lastName"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#3A4E62] mb-2">Email *</label>
                      <Input
                        type="email"
                        name="email"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#3A4E62] mb-2">Your phone number *</label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-[#3A4E62] mb-2">Home/Company</label>
                      <select
                        name="company"
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-[#3A4E62] mb-2">Full Name *</label>
                  <Input
                    name="name"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#3A4E62] mb-2">Email Address *</label>
                  <Input
                    type="email"
                    name="email"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#3A4E62] mb-2">Phone Number</label>
                  <Input
                    type="tel"
                    name="phone"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#3A4E62] mb-2">What service do you need? *</label>
                  <select
                    name="service"
